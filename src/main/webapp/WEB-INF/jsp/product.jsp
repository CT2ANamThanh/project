del<%-- 
    Document   : product
    Created on : Oct 27, 2020, 9:51:04 AM
            ...
            <!-- Navbar -->
             <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a  class="nav-link" href="addNewProduct">Add New Product</a>
                    </li>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Product Manager</h1>
                            </div>                           
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <c:forEach var="product" items="${productList}">
                                    <tr>
                                        ...
                                        <td>${product.name}</td>
                                        <td>${product.priceFormatted}VND</td>                                                                 
                                        <td>${product.battery}</td>
                               
                                        <td><a href="details1/${product.id}">Details</a></td>
                                        <td><a href="edit/${product.id}" style="color: yellowgreen;" class="fa fa fa-pen"></a></td>
                                        <td><a href="delete1/${product.id}" style="color: red;" class="fa fa-trash"></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
