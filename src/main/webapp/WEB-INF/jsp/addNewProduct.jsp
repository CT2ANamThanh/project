<%-- 
    ...
    Created on : Oct 4, 2020, 4:01:43 PM
...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <!-- LIST PRODUCT -->
            <mvc:form modelAttribute="product" action="addNewProduct" method="post" enctype="multipart/form-data">
                <table>
                    <tr>
                        <td>Image</td>
                    ...
                    <tr>
                        <td>Provider(*):</td>
                        <td><mvc:select path="provider.id" class="form-control">
                                <mvc:options items="${providerList}"/>
                            </mvc:select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Price(*):</td>
                        <td><mvc:input path="price" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Screen(*):</td>
                        <td><mvc:input path="screen" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Resolution(*):</td>
                        <td><mvc:input path="resolution" required="true"/></td>
                    </tr>

                    <tr>
                        <td>Screen Type(*):</td>
                        <td><mvc:input path="screenType" required="true"/></td>
                    </tr>

                    <tr>
                        <td>CPU(*):</td>
                        <td><mvc:input path="cpu" required="true"/></td>
                    </tr>
                    <tr>
                        <td>RAM(*):</td>
                        <td><mvc:input path="ram" required="true"/></td>
                    </tr>
                    <tr>
                        <td>System(*):</td>
                        <td><mvc:input path="system" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Front Camera(*):</td>
                        <td><mvc:input path="frontCamera" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Rear Camera(*):</td>
                        <td><mvc:input path="rearCamera" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Internal Memory(*):</td>
                        <td><mvc:input path="internalMemory" required="true"/></td>
                    </tr>

                    <tr>
                        <td>Graphic Chip(*):</td>
                        <td><mvc:input path="graphicsChip" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Weight(*):</td>
                        <td><mvc:input path="weight" required="true"/></td>
                    </tr>
                    <tr>
                        <td>Battery(*):</td>
                        <td><mvc:input path="battery" required="true"/></td>
                    </tr>
