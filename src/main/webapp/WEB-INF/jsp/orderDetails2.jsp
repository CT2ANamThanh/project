<%-- 
    ...
    Created on : Oct 21, 2020, 9:56:11 AM
            ...
            <div class="content-wrapper">
                ...
                <div  class="col-md-4">
                    ...
                    <table class="table table-hover">
                        ...
                        <div>
                            <img style="height:80px;" src="<c:url value='../images/phone/phone1.jpg'/>"  alt="">
                        </div>
                        <thead>
                            <tr>
                                <th>Provider</th>
                        ...
                        <tbody>
                            ...
                            <td>${orderDetails.product.provider.providerName}</td>
                            <td>${orderDetails.product.name}</td>
                            <td>${orderDetails.product.priceFormatted}</td>
