<%-- 
    Document   : addNewProvider
    Created on : Oct 22, 2020, 12:04:48 PM
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Add New Provider</h1>
                        </div>                           
                    </div>
                </div>
            </div>
            ...
            <!-- LIST PRODUCT -->
            <mvc:form modelAttribute="provider" action="addNewProvider" method="post">
                <table>
                    
                    <tr>
                        <td>Name(*):</td>
                        <td><mvc:input path="providerName" class="form-control"/></td>
