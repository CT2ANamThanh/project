        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="shopping">Điện Thoại</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="shopping">Máy tính</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="shopping">Phụ Kiện</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <c:forEach var="product" items="${productList}">
                            <div style="margin-bottom: 2px ; margin-top: 32px" class="col-lg-4 col-md-12 mb-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer">
                                        <input    onclick="location.href = '${pageContext.request.contextPath}/details/${product.id}'"  style="background: #ffcc00;margin-left: 60px;color: red ;width: 80px; height: 40px;" type="button" value="Mua" />
                                    </div>
