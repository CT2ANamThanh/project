<%-- 
    ...
    Created on : Oct 23, 2020, 9:38:51 AM
...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <!-- LIST PRODUCT -->
            <mvc:form modelAttribute="provider" action="${pageContext.request.contextPath}/update2" method="post">
                <table>
                    
                    <tr>
                        <td>Name(*):</td>
                        <td><mvc:input path="providerName" required="true"/></td>
                    </tr>
                    <td><mvc:input path="id" type="hidden" required="true"/></td>
                    <tr>
